...
namespace AstronnERP.Domain.Purchasing.Master.Counterparties
{
    public record RussianGovernmentDetails : CounterpartyDetails
    {
        ...
        public static Result<RussianGovernmentDetails> Create(string taxNumber, string kpp)
        {
        ...
        public Result ChangeTaxNumber(string newTaxNumber)
        {
            ...
            failureCheck = Result.FailIf(!AccountValidator.IsThisGovernmentINN(newTaxNumberValidationResult.Value), "INN is invalid.");
